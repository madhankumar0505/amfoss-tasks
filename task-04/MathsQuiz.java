/*I wish to type down all the errors I encountered :
   
   I]SYNTAX ERRORS:
   1)missing semicolons;
   2)unwanted use of commentline//
   3)missing braces()
   
   II]LOGICAL ERRORS:
   1)conversion of milliseconds to seconds was written as 1ms=0.01s.
   2)operators were wrongly misplaced.
   3)every correct answer was incremented with -1.
   4)every wrong answer was incremented with +23. 
   5)start and stop buttons were working the opposite.
   
   III]TYPE ERRORS:
   1)multiply was wrongly written as multipy.
   
   Hope so I covered all errors. Thanks to Lenna for your comments that helped me to debug easily :)
...
public class Math_Quiz extends JFrame {
    ...
    public static void main(String[] args) {
        final Math_Quiz frame = new Math_Quiz();
        frame.pack();
